 ...
 * @desc código do Controller da página de conversão (regras de negócio)
 */
class ControllerConversao {
    constructor() {
        this.formConversaoEl = document.getElementById('form-conversao');
    ...
    getValues() {
        [...this.formConversaoEl.elements].forEach((field) => {
    ...
    initialize() {
        this.formConversaoEl.addEventListener('submit', (event) => {
        ...
        this.elemento2El.addEventListener('change', (event) => {
            /* bloco de ação do evento change do elemento 2 */
            this.getValues(); /* chama método que obtém os dados do formulário */
            if (this.dados.elemento2 == '') {
